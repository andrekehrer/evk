...
class Compras extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('customers/compras_model');
	}
	public function index(){   
        ...
        $data['compras'] = $this->compras_model->lista_compras($id);

        $this->load->view('customers/compras', $data);
	}
    ...
    //     $this->load->view('customers/add_viagens', $data);
    // }
    ...
    //     redirect('customers/edit_viagem/'.$id_viagem);
    // }
    ...
    //     $this->load->view('customers/edit_viagem', $data);
    // }
