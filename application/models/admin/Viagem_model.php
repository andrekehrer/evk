...
class Viagem_model extends CI_Model
{
	...
	public function lista_viagens(){
		$data = $this->db->get('viagens')->result();
		return $data;
	}
    ...
    public function lista_clientes_by_id($viagem_id){
        $data = $this->db->get_where('usuarios', array('id' => $viagem_id))->result();
		return $data;
    }
