      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <form id="myform" class="forms-sample" action="<?=base_url()?>admin/frotas/add_frota_gravar" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <div class="switch" style="margin-top: -14px;">
                                        <input type="checkbox" name="perfuratriz" id="gooey-switch1"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="placa" name="placa" placeholder="Placa" value="" >        
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="airtag" name="airtag" placeholder="Número da Air Tag" value="" >        
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="numero_seguro" name="numero_seguro" placeholder="Número do Seguro" value="" >        
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="vigente">Validade do Seguro</label>
                                    <input type="date" class="form-control" id="vigente" name="vigente">    
                                </div>
                            </div>
                        </div>
                    </div>
