<?php include('header.php'); ?>
    <style>
        ...
        #foto_equipamento{width: 40px;height: 40px;border-radius: 50%;border: 3px #4ac5bf solid;}
    </style>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row mb-4">
                <div class="col-lg-12">
                    <a href="<?=base_url()?>admin/equipamentos/add_equipamento" class="btn btn-block btn-gradient-primary">  <i class="mdi mdi-account-plus"></i> Cadastrar equipamento</a>
                </div>
            </div>    
            <div class="row">
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php if(count($equipamentos)<=0){ ?>
                        <p class="card-description"> Nenhum Equipamento</code><br></p>
                    <?php }else { ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                if($row->foto == ''){
                                                    ...
                                                    $foto = base_url().'assets/equipamentos/'.$row->foto;
                                                }
                                            ?>
                                            ...
                                            <td>
                                                <a href="<?=base_url()?>admin/equipamentos/edit_equipamento/<?=$row->id?>"><i class="mdi mdi-pencil"></i></a>
                                                <?php if($row->status == 0){ ?>
                                                    <img src="" alt="">
