...
<style>
    ...
    ._30p{width: 30%;}
    ._40p{width: 40%;}
    .parametro{font-size: 11px !important;vertical-align: baseline !important;}
    .parametro_un{font-size: 11px;margin-left: 2px;}
    .par_inp{width: 60% !important;display: inline}
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <input type="hidden" class="form-control" id="id_rds" name="id_rds" value="<?=$rds_id?>" readonly>  
                    ...
                    <div class="row_border">
                        <div class="row">
                            <p style="text-align: center;"><b>Tubo 2</b></p>
                    ...
                    <div class="row_border">
                         <div class="row">
                            ...
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="text-align: center !important;">
                                    <label>Resultados  Unidade</label>           
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Horario de Inicio de Solda:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Temp. da placa de Solda:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Desaslinhamento Max Permitido</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Desaslinhamento Observado:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Fresta max Permitida:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Fresta Observada:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Pressão de Arraste:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Pressão de Solda:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Pressão de Pré Aquecimento/junção:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Pressão de Aquecimento / Simples contato:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Tempo para retirada da placa de aquecimento:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Tempo de Resfriamento:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Largura inicial do cordão:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Largura final do cordão:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Término da solda:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 _40p">
                                <div class="form-group">
                                    <label class="parametro">Previsão de horario de liberação da solda:</label>           
                                </div>
                            </div>
                            <div class="col-lg-6 _60p">
                                <div class="form-group" style="width: 70%;">
                    ...
                    <div class="row_border">
                        <p style="text-align: center;"><b>Descrição do equipamento de solda</b></p>
