<?php include('header.php'); ?>
    <style>
        ...
        #foto_produto{width: 40px;height: 40px;border-radius: 50%;border: 3px #4ac5bf solid;}
    </style>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row mb-4">
                <div class="col-lg-12">
                    <a href="<?=base_url()?>admin/produtos/add_produto" class="btn btn-block btn-gradient-primary">  <i class="mdi mdi-account-plus"></i> Cadastrar produto</a>
                </div>
            </div>    
            <div class="row">
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php if(count($produtos)<=0){ ?>
                        <p class="card-description"> Nenhum produto</code><br></p>
                    <?php }else { ?>
                                ...
                                <?php foreach($produtos as $row){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                            if($row->fabricante){
                                                $fabricante = $this->db->get_where('fabricantes', array('id' => $row->fabricante))->result();
                                                echo   $fabricante[0]->nome;  
                                            }
                                            ?>
                                        </td>
                                        <td>
                                            <a href="<?=base_url()?>admin/produtos/edit_produto/<?=$row->id?>"><i class="mdi mdi-pencil"></i></a>
                                            <?php if($row->status == 0){ ?>
                                                <img src="" alt="">
