          ...
          <div class="content-wrapper">
            <div class="page-header">
                <h3 class="page-title">
                    ...
                    Selecione o status dos Funcionarios
                </h3>
            </div>
            <div class="row mb-4">
                <div class="col-lg-12">
            ...
            <div class="row">
              <div class="col-lg-6">
                <a href="<?=base_url()?>admin/funcionarios/funcionarios_ativo" class="btn btn-block btn-gradient-primary">  <i class="mdi mdi-account-plus"></i> Funcionários ativos</a>
                <a href="<?=base_url()?>admin/funcionarios/funcionarios_desativados" class="btn btn-block btn-gradient-primary">  <i class="mdi mdi-account-plus"></i> Funcionários desativados</a>
              </div>
            </div>
        </div>
        <div class="row mt-4">
