<?php include('header.php'); ?>
    <style>
        ...
        @media only screen and (max-width: 600px) {
            .btn_rd{
                padding: 5px 2px;border: 1px #3a3c53 solid;border-radius: 4px;
            }
            .nome_size{width: 10% !important;}
            .status_size{width: 10% !important;}
            .numero_size{width: 10% !important;}
        }
        @media only screen and (min-width: 601px) {
            .btn_rd{
                padding: 5px 5px;border: 1px #3a3c53 solid;border-radius: 4px;
            }
        }
    </style>
                                    ...
                                    <?php foreach($obras as $row){ ?>
                                        <tr>
                                            <td class="status_size">
                                                <?php if($row->status == 0){ ?>
                                                    <img src="" alt="">
                                                    <i class="mdi mdi-checkbox-blank-circle mdi-24px" style="color: red;"></i>
                                                <?php }else{?>
                                                    <i class="mdi mdi-checkbox-blank-circle mdi-24px" style="color: green;"></i>
                                                <?php }?>
                                            </td>
                                            <td class="numero_size"><?=$row->numero_id?></td>
                                            <td class="nome_size"><?=$row->nome?></td>
                                            <td>
                                                <a href="<?=base_url()?>admin/obras/edit_obra/<?=$row->id?>"><i class="mdi mdi-pencil mdi-24px"></i></a>
                                                <a style="text-decoration: none;" href="<?=base_url()?>admin/obras/lista_rdos/<?=$row->id?>">
                                                    <span class="btn_rd">RDOs</span>
                                                    <!-- <i class="mdi mdi-format-list-bulleted mdi-24px"></i> -->
                                                </a>
                                                <a style="text-decoration: none;" href="<?=base_url()?>admin/obras/lista_rdfs/<?=$row->id?>">
                                                <span class="btn_rd">RDFs</span>
                                                    <!-- <i class="mdi mdi-format-list-bulleted mdi-24px"></i> -->
                                                </a>
                                            </td>
                                        </tr>
