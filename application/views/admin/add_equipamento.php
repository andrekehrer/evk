      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <form id="myform" class="forms-sample" action="<?=base_url()?>admin/equipamentos/add_equipamento_gravar" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <!-- <input class="form-check-input" type="checkbox" role="switch" name="status" id="status"> -->
                                    <div class="switch" style="margin-top: -14px;">
                                        <input type="checkbox" name="rastreador" id="gooey-switch2"/>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="patrimonio" name="patrimonio" placeholder="Patrimonio" value="" required>        
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="fabricante" name="fabricante" placeholder="Fabricante" value="" >        
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="proprietario" name="proprietario" placeholder="Proprietario" value="" required>        
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="seguro" name="seguro" placeholder="Seguro" value="" required>        
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="vigencia">Vigencia</label>
                                    <input type="date" class="form-control" id="vigencia" name="vigencia" value="">        
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ano" name="ano" placeholder="2020" value="" >        
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="chassi" name="chassi" placeholder="Chassi / Número de Série" value="" >        
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="renavam">Renavam</label>
                                    <input type="text" class="form-control" id="renavam" name="renavam" placeholder="Renavam" value="" >        
                                </div>
                            </div>
                        </div>
                    </div>
