<?php include('header.php'); ?>
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php if(count($rdfs)<=0){ ?>
                        <p class="card-description"> Nenhum RDf</code><br></p>
                    <?php }else { ?>
                            ...
                            <tbody>
                                    <?php foreach($rdfs as $row){?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?=base_url()?>admin/rdf/carrega_rdf/<?=$row->obra_id?>/<?=$row->id?>/"><i style="color: #444497 !important;" class="mdi mdi-pencil mdi-24px"></i></a>
                                                <a target="_blank" href="<?=base_url()?>admin/rdf/export_rdf/<?=$row->obra_id?>/<?=$row->id?>"><i style="color: #444497 !important;" class="mdi mdi-file-pdf mdi-24px"></i></a>
                                                <a data-id="<?=$row->id?>" onclick="excluir(this)"><i style="color: #c11c1c !important;" class="mdi mdi-delete mdi-24px" data-tooltip="Excluir RDF"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
    ...
    <script>
        function excluir(data){
            var name=confirm("Deseja realmente excluir a RDF?")
            if (name==true){
                ...
                $.ajax({
                    type: "POST",
                    url: site_url + "admin/rdf/ /",
                    data: "id=" + id,
                    success: function(resp) {
                        alert('RDF excluida com sucesso!')
