...
<style>.bg-gradient-info {
    ...
    #foto_equipamento{width: 150px;height: 150px;border-radius: 50%;margin-bottom: 20px;border: 3px #4ac5bf solid;}
...
<?php
    if($equipamento[0]->foto == ''){
        $foto_eq = 'https://cdn-icons-png.flaticon.com/512/149/149071.png';
    }else{
        $foto_eq = base_url().'assets/equipamentos/'.$equipamento[0]->foto;
    }
?>
<!-- <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous"> -->
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <form class="forms-sample" action="<?=base_url()?>admin/equipamentos/edit_equipamento_gravar" method="POST" enctype="multipart/form-data">
            <div class="content-wrapper">
                <div style="background-image: url(<?=$foto_eq?>);background-color: #cccccc;height: 150px;width: 150px;background-position: center;background-repeat: no-repeat;background-size: cover;position: relative;border-radius: 50%;margin-bottom: 8px;border: 3px #4ac5bf solid;"></div>
                    <div class="panel">
                    ...
                    <div class="page-header" style="margin: 0px !important">
                        <p style="margin-bottom: 0px !important">Detalhes do Equipamento</p>
                    </div>
                    ...
                    <input type="hidden" class="form-control" id="id" name="id" placeholder="" value="<?=$equipamento[0]->id?>">
                    <div class="row_border">
                        <div class="row">
                            <div class="col-lg-1">
                                <div class="form-group">
                                    ...
                                    <div class="switch" style="margin-top: -14px;">
                                        <input type="checkbox" name="status" <?=$equipamento[0]->status == 1 ? 'checked' : '' ?> id="gooey-switch"/>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="nome">Rastreador?</label><br>
                                    <!-- <input class="form-check-input" type="checkbox" role="switch" name="status" id="status"> -->
                                    <div class="switch" style="margin-top: -14px;">
                                        <input type="checkbox" name="rastreador" <?=$equipamento[0]->rastreador == 1 ? 'checked' : '' ?> id="gooey-switch2"/>
                                        <label id="gooey" for="gooey-switch2">On/Off</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="patrimonio" name="patrimonio" placeholder="Patrimonio" value="<?=$equipamento[0]->patrimonio?>" required>        
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="nome">Nome</label>
                                    <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome" value="<?=$equipamento[0]->nome?>" required>        
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="fabricante">Fabricante</label>
                                    <input type="text" class="form-control" id="fabricante" name="fabricante" placeholder="Fabricante" value="<?=$equipamento[0]->fabricante?>" >        
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="proprietario" name="proprietario" placeholder="Proprietario" value="<?=$equipamento[0]->proprietario?>" required>        
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="cnpj">CNPJ</label>
                                    <input type="text" class="form-control" id="cnpj" name="cnpj" placeholder="CNPJ" value="<?=$equipamento[0]->cnpj?>" required>        
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="seguro">Seguro</label>
                                    <input type="text" class="form-control" id="seguro" name="seguro" placeholder="Seguro" value="<?=$equipamento[0]->seguro?>" required>        
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="vigencia">Vigencia</label>
                                    <input type="date" class="form-control" id="vigencia" name="vigencia" placeholder="Vigencia" value="<?=$equipamento[0]->vigencia?>">        
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ano" name="ano" placeholder="2020" value="<?=$equipamento[0]->ano?>" >        
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="cor">Cor</label>
                                    <input type="text" class="form-control" id="cor" name="cor" value="<?=$equipamento[0]->cor?>" >
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                <label for="chassi">Chassi / Número de Série</label>
                                    <input type="text" class="form-control" id="chassi" name="chassi" placeholder="Chassi / Número de Série" value="<?=$equipamento[0]->chassi?>" >         
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="renavam">Renavam</label>
                                    <input type="text" class="form-control" id="renavam" name="renavam" placeholder="Renavam" value="<?=$equipamento[0]->renavam?>" >        
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="<?=base_url()?>admin/equipamentos" class="btn_voltar"><i class="mdi mdi-keyboard-return"></i> Voltar</a>
            </div>
        ...
        var btnUpload = $("#upload_file"),
            ...
            if($.inArray(ext, ['gif','png','jpg','jpeg']) == -1) {
                ...
                setTimeout(function(){
                    ...
                    $("#foto_equipamento").css('display', 'none');
