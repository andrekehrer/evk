      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <form id="myform" class="forms-sample" action="<?=base_url()?>admin/clientes/add_cliente_gravar" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="registro" name="registro" placeholder="Registro" value="" required>        
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label for="cnpj">CNPJ</label>
                                    <input type="text" class="form-control" id="cnpj" name="cnpj" placeholder="CNPJ" value="" >        
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="razao_social" name="razao_social" placeholder="Razao Social" value="" >        
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="contato" name="contato" placeholder="Contato" value="" >   
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="cargo" id="cargo">
                                        ...
                                        <option value="5">Gestor contrato</option>
                                    </select>
                                </div>
                            </div>
                        </div>
