      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row mb-4">
                <div class="col-lg-12">
                    <a href="<?=base_url()?>admin/rdf/criar_rdf/<?=$obra_id?>" class="btn btn-block btn-gradient-primary">  <i class="mdi mdi-format-list-bulleted"></i> Criar rdf</a>
                </div>
            </div>    
            <div class="row">
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php if(count($rdfs)<=0){ ?>
                        <p class="card-description"> Nenhuma RDF</code><br></p>
                    <?php }else { ?>
                            ...
                            <tbody>
                                    <?php foreach($rdfs as $row){ ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?=base_url()?>admin/rdf/carrega_rdf/<?=$obra_id?>/<?=$row->id?>/"><i class="mdi mdi-pencil mdi-24px"></i></a>
                                                <a href="<?=base_url();?>admin/rdf/export_rdf/<?=$obra_id?>/<?=$row->id?>/" target="_blank"><i class="mdi mdi-file-pdf mdi-36px"></i></a>
                                                <!-- <a href="<?=base_url()?>admin/rdf/add_lista/<?=$obra_id?>/<?=$row->id?>"><i class="mdi mdi-format-list-bulleted mdi-24px"></i></a> -->
                                            </td>
                                        </tr>
                                    <?php } ?>
