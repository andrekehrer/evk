<?php include('header.php'); ?>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row mb-4">
                <div class="col-lg-12">
                    <a href="<?=base_url()?>admin/funcionarios/add_funcionario" class="btn btn-block btn-gradient-primary">  <i class="mdi mdi-account-plus"></i> Cadastrar Funcionario</a>
                </div>
            </div>    
            <div class="row">
              <div class="col-lg-6">
                <a style="background: #d1d2df;color: #282828;" href="<?=base_url()?>admin/funcionarios/funcionarios_ativo" class="btn btn-block">  <i class="mdi mdi-account-plus"></i> Funcionários ativos</a>
                <a style="background: #2e314a;color: white;" href="<?=base_url()?>admin/funcionarios/funcionarios_desativados" class="btn btn-block btn-ativo">  <i class="mdi mdi-account-plus"></i> Funcionários desativados</a>
              </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php if(count($funcionarios)<=0){ ?>
                        <p class="card-description"> Nenhum Cliente</code><br></p>
                    <?php }else { ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                if($row->foto == ''){
                                                    ...
                                                    $foto = base_url().'assets/funcionarios/'.$row->foto;
                                                }
                                            ?>
                                            ...
                                            <td><?=$row->sobrenome?></td>
                                            <td>
                                                <a href="<?=base_url()?>admin/funcionarios/edit_funcionario/<?=$row->id?>"><i class="mdi mdi-pencil mdi-24px" data-tooltip="Editar Usuario"></i></a>
                                                <a href="<?=base_url();?>admin/funcionarios/export_funcionario/<?=$row->id?>" target="_blank"><i class="mdi mdi-file-pdf mdi-36px" data-tooltip="Exportar Usuario"></i></a>
                                                <?php if($row->status == 0){ ?>
                                                    <img src="" alt="">
                                                    <i class="mdi mdi-checkbox-blank-circle mdi-24px" data-tooltip="Status do usuário Usuario" style="color: red;"></i>
                                                <?php }else{?>
                                                    <i class="mdi mdi-checkbox-blank-circle mdi-24px" data-tooltip="Status do usuário Usuario" style="color: green;"></i>
                                                <?php }?>
                                                <a data-id="<?=$row->id?>" onclick="mudar_senha(this)"><i class="mdi mdi-lock mdi-36px" data-tooltip="Alterar senha para 123"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
    ...
    <script>
        function mudar_senha(data){
            var name=confirm("Deseja realmente alterar a senha para 123?")
            if (name==true){
                ...
                $.ajax({
                    type: "POST",
                    url: site_url + "admin/funcionarios/alterar_senha/",
                    data: "id =" + id,
