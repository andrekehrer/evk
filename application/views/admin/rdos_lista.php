              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php if(count($rdos)<=0){ ?>
                        <p class="card-description"> Nenhuma RDO</code><br></p>
                    <?php }else { ?>
                            ...
                            <tbody>
                                    <?php foreach($rdos as $row){ ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?=base_url()?>admin/rdo/carrega_rdo/<?=$obra_id?>/<?=$row->id?>/"><i class="mdi mdi-pencil mdi-24px"></i></a>
                                                <a href="<?=base_url();?>admin/rdo/export_rdo/<?=$obra_id?>/<?=$row->id?>/" target="_blank"><i class="mdi mdi-file-pdf mdi-36px"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
