<?php include('header.php'); ?>
    <style>
        ...
        #foto_cliente{width: 40px;height: 40px;border-radius: 50%;border: 3px #4ac5bf solid;}
    </style>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row mb-4">
                <div class="col-lg-12">
                    <a href="<?=base_url()?>admin/clientes/add_cliente" class="btn btn-block btn-gradient-primary">  <i class="mdi mdi-account-plus"></i> Cadastrar cliente</a>
                </div>
            </div>    
            <div class="row">
              <div class="col-lg-12">
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                if($row->foto == ''){
                                                    ...
                                                    $foto = base_url().'assets/clientes/'.$row->foto;
                                                }
                                            ?>
                                            ...
                                            <td>
                                                <a href="<?=base_url()?>admin/clientes/edit_cliente/<?=$row->id?>"><i class="mdi mdi-pencil"></i></a>
                                                <?php if($row->status == 0){ ?>
                                                    <img src="" alt="">
