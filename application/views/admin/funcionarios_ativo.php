      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-lg-6">
                <a style="background: #2e314a;color: white;" href="<?=base_url()?>admin/funcionarios/funcionarios_ativo" class="btn btn-block btn-ativo">  <i class="mdi mdi-account-plus"></i> Funcionários ativos</a>
                <a style="background: #d1d2df;color: #282828;" href="<?=base_url()?>admin/funcionarios/funcionarios_desativados" class="btn btn-block">  <i class="mdi mdi-account-plus"></i> Funcionários desativados</a>
              </div>
            </div>
            <br>  
            <div class="row">
