<?php include('header.php'); ?>
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php if(count($rdos)<=0){ ?>
                        <p class="card-description"> Nenhum RDO</code><br></p>
                    <?php }else { ?>
                            ...
                            <tbody>
                                    <?php foreach($rdos as $row){?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?=base_url()?>admin/rdo/carrega_rdo/<?=$row->obra_id?>/<?=$row->id?>/"><i style="color: #c11c1c !important;" class="mdi mdi-pencil mdi-24px"></i></a>
                                                <a target="_blank" href="<?=base_url()?>admin/rdo/export_rdo/<?=$row->obra_id?>/<?=$row->id?>"><i style="color: #444497 !important;" class="mdi mdi-file-pdf mdi-24px"></i></a>
                                                <a data-id="<?=$row->id?>" onclick="excluir(this)"><i style="color: #c11c1c !important;" class="mdi mdi-delete mdi-24px" data-tooltip="Excluir RDO"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
    ...
    <script>
        function excluir(data){
            var name=confirm("Deseja realmente excluir a RDO?")
            if (name==true){
                ...
                $.ajax({
                    type: "POST",
                    url: site_url + "admin/rdo/excluir_rdo/",
                    data: "id=" + id,
                    success: function(resp) {
                        alert('RDO excluida com sucesso!')
