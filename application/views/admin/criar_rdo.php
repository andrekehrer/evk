                ...
                <input type="hidden" class="form-control" id="id_rdo" name="id_rdo" value="<?=$rdo_id?>" readonly>  
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="obs" class="form-control"  name="obs" rows="20" cols="50"><?=$rdos[0]->obs?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- <div class="row_border">
                        ...
                        <?php foreach($produtos as $row){
                            ...
                            $value = 0;
                            $data = $this->db->get_where('produtos_rdo', array('produto_id' => $row->id, 'rdo_id' => $rdo_id));
                            if($data->num_rows() > 0){
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="produtos" name="produtos_<?=$row->id?>" style="width: 300px !important;" value="<?=$value?>">
                                </div>
                            </div>
                            <?php } ?>
                        </div>
