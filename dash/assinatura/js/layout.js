/** 
 * DinarteCoelho MeuLayout Layout
 */
DinarteCoelho.widget.MeuLayout = DinarteCoelho.widget.BaseWidget.extend({
...
DinarteCoelho.MeuLayoutConfigurator = {
    ...
    beforeResourceChange: function() {
        DinarteCoelho.ajax.RESOURCE = null;    //prevent resource append
    },

    replaceLink: function(linkElement, href) {
        DinarteCoelho.ajax.RESOURCE = 'Resource';
    ...
    clearLayoutState: function() {
        var menu = DC('MeuLayoutMenuWidget');
...
if (DinarteCoelho.widget.InputSwitch) {
    DinarteCoelho.widget.InputSwitch = DinarteCoelho.widget.InputSwitch.extend({
...
if (DinarteCoelho.widget.AccordionPanel) {
    DinarteCoelho.widget.AccordionPanel = DinarteCoelho.widget.AccordionPanel.extend({
...
if(window['DinarteCoelho'] && window['DinarteCoelho'].widget.Dialog) {
    DinarteCoelho.widget.Dialog = DinarteCoelho.widget.Dialog.extend({
...
if (DinarteCoelho.widget.SelectOneMenu) {
    DinarteCoelho.widget.SelectOneMenu = DinarteCoelho.widget.SelectOneMenu.extend({
        init: function (cfg) {
            this._super(cfg);
...
if (DinarteCoelho.widget.Chips) {
    DinarteCoelho.widget.Chips = DinarteCoelho.widget.Chips.extend({
        init: function (cfg) {
            this._super(cfg);
...
if (DinarteCoelho.widget.DatePicker) {
    DinarteCoelho.widget.DatePicker = DinarteCoelho.widget.DatePicker.extend({
        init: function (cfg) {
            this._super(cfg);
